...
export default function DashboardPage() {
  ...
  return (
    <div className={`flex w-full h-screen p-4 gap-6 overflow-hidden transition-colors duration-500  ${isDark
      ...
      <main className={`flex-1 h-full overflow-y-auto pr-2 flex flex-col gap-6 fade-edge-top transition-colors duration-500 liquid-scrollbar ${isDark ? "text-gray-100" : "text-gray-900"
        }`}>
        <div>
          <ThemeSwitcher />
        </div>
